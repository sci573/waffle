...
$(function(){
	...
	if(confirm("수정하시겠습니까?")){
		document.form1.action="${path}/waffleContent/admin_edit.do";
	...
	<div id="cont_wrap">
		<form name="form1" method="post">
			...
			<div id="cont_left">
				...
				<p>| <input value="${dto.year}" id="year" name="year" placeholder="Year"></p>
				
				<div class="box">
					<div class="actor">CAST</div>
					<p><input value="${dto.cast}" class="cont_long" id="cast" name="cast" placeholder="Cast"></p>
				</div>
				<div class="desc">
					<p><textarea id="description" name="description" rows="10" cols="80" placeholder="Description">${dto.description}</textarea></p>
				</div>
			</div>
			...
			<div id="cont_right">
				<div class="intro_post">
					<input value="${dto.poster}" id="poster" name="poster" placeholder="Poster URL">
				</div>
				<div id="box_cont">
					<ul>
						<li>
							<h4 face="malgun gothic">RATED</h4>
					    	<h3><input value="${dto.rated}" class="cont_small" id="Rated" name="rated" placeholder="Rated"></h3>  
						</li>
						<li>
							<h4 face="malgun gothic">GENRE</h4>
					 		<h3><input value="${dto.genre}" class="cont_small" id="genre" name="genre" placeholder="Genre"></h3>
						</li>
						<li>
							<h4 face="malgun gothic">CATEGORY</h4>
							<h3><input value="${dto.category}" class="cont_small" id="category" name="category" placeholder="Category"></h3>
						</li>
					</ul>
				</div>
			</div>
