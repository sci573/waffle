...
//첫번째 카테고리 : 로맨스
function movie_romance() {
	$.ajax({
		type:"post",
		url:"${path}/waffleContent/movie_romance.do",
		dataType:"html",
...
//두번째 카테고리 : 스릴러
function movie_thriller() {
	$.ajax({
		type:"post",
		url:"${path}/waffleContent/movie_thriller.do",
		dataType:"html",
		success:function(result) {
...
function movie_action() {
	$.ajax({
		type:"post",
		url:"${path}/waffleContent/movie_action.do",
		dataType:"html",
		success:function(result) {
...
//네번째 카테고리 : 코미디
function movie_comedy() {
	$.ajax({
		type:"post",
		url:"${path}/waffleContent/movie_comedy.do",
		dataType:"html",
		success:function(result) {
...
function movie_sf() {
	$.ajax({
		type:"post",
		url:"${path}/waffleContent/movie_sf.do",
		dataType:"html",
		success:function(result) {
